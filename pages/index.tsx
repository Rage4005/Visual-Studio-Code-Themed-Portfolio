...
const Home: NextPage = () => {
  ...
  return (
    <>
      <Head>
        <title>Arman Khan| Software Development Engineer</title>
        <meta
          name="description"
        ...
        <meta
          property="og:title"
          content={
            "Arman Khan - Software Development Engineer &amp; Product Developer"
          }
        />
        <meta
          name="description"
        ...
        <div className="container vscodecontainer mx-auto max-w-5xl w-full p-6 mb:p-12">
          <div className="flex flex-col mt-1 md:flex-row md:space-x-4">
            <div className="flex-1 mb-4 md:mb-0 ">
              <div className="p-2">
                <h2 className="text-5xl font-sans	 mb-2 ">Arman Khan</h2>
                <h3 className="text-2xl font-sans	 text-gray-500 pt-1 mb-2">
                  AI Developer/Data Analyst/Web Developer
                </h3>
              ...
              >
                ...
                <div className="pt-1">
                  <Link
                    passHref
                    target="_blank"
                    href="https://www.linkedin.com/in/armankhan4005/"
                  >
                    <div
                ...
                <div className="mt-4">
                  ...
                  >
                    ...
                    >
                      <img src="/dev.png" width="28" height="28" />{" "}
                      <p className="text-gray-200 text-sm  font-sans flex justify-start items-center">
                        Dev Community
                      </p>
                    </div>
